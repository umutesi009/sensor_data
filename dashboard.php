...
table {
    ...
    border: 1px solid #dddddd; /* outer border for the table */
}

th, td {
    padding: 12px 15px;
    text-align: center;
    border-bottom: 1px solid #dddddd; /* horizontal lines */
    border-right: 1px solid #dddddd;  /* vertical lines */
}
...
th {
  ...
  .temp-medium { color: #ff00ff; }   /* Orange for moderate */
  .temp-high { color: #c536f4; }     /* Red for hot */
